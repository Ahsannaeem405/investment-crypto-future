          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistic-block block">
              <div class="progress-details d-flex align-items-end justify-content-between">
                ...
                <div style="color:white !important  " class="number dashtext-2">${{$all}}</div>
              </div>
              <div class="progress progress-template">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="statistic-block block">
              <div class="progress-details d-flex align-items-end justify-content-between">
                <div class="title">
                  <div class="icon"><i class="fa fa-user" style="color: #e95f71;"></i></div><strong style="font-size: 13px;">Total Users</strong>
                </div>
                <div class="number dashtext-2" style="color:white !important">{{$user}}</div>
              </div>
              <div class="progress progress-template">
                <div role="progressbar" style="width: 100%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-template dashbg-2"></div>
              </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="line-chart block chart">
              ...
              <canvas id="lineChartCustom4"></canvas>
            </div>
          </div>
          <div class="col-lg-4">
          ...
          <div class="col-lg-4">
            <div class="line-chart block chart">
              ...
              <canvas id="lineChartCustom5"></canvas>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="chart block">
