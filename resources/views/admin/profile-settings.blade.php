                        ...
                        <div class="block-body">
                            <nav id="sidebar" style="border-right: 0px;width: auto;margin-left:-17px;">
                              ...
                              <ul class="list-unstyled">
                                ...
                                <li class=""><a href="{{route('admin.referral-profit')}}"> <i class="fa fa-dollar"></i>Referral Profit </a></li>
                              </ul>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="block-body">
                            <form class="form-horizontal" method="post" action="{{route('admins.update_information')}}"  enctype='multipart/form-data'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="inputHorizontalSuccess" type="file"   placeholder="WBTC Address" class="form-control form-control-success" name="ada_file">
                                    </div>
                                </div>
