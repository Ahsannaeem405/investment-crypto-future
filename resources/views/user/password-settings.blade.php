                        ...
                        <div class="block-body">
                            <nav id="sidebar" style="border-right: 0px;width: auto;">
                              ...
                              <ul class="list-unstyled">
                                <li class=""><a href="{{route('user.profile-settings')}}"> <i class="fa fa-user"></i>Profile Settings</a></li>
                                <li class="active"><a href="{{route('user.settings')}}"> <i class="fa fa-unlock"></i>Change Password</a></li>
                        ...
                        <div class="block-body">
                            <form class="form-horizontal" method="post" action="{{route('user.change_password')}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="inputHorizontalWarning" type="password" placeholder="New Pasword" class="form-control  @error('New_Password') is-invalid @enderror form-control-warning" name="New_Password" required>
