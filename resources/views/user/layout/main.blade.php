  ...
  <div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled">
        <li class="{{ Request::is('user/index') ? 'active' : '' }}"><a href="{{url('user/index')}}"> <i class="icon-home"></i>Dashboard</a></li>
       
        <li class="{{ Request::is('user/profit') ? 'active' : '' }}"><a href="{{url('user/profit')}}"> <i class="icon-doller">$</i> Investment Plan</a></li>
        <li class="{{ Request::is('user/deposit') ? 'active' : '' }}"><a href="{{url('user/deposit')}}"> <i class="icon-grid"></i>Deposit</a></li>
        <li><a href="{{route('user.withdraw')}}"> <i class="icon-padnote"></i>Withdraw</a></li>
        <li><a href="{{route('user.referrals')}}"> <i class="icon-logout"></i>Referral User</a></li>
        <li class="{{ Request::is('user/settings') ? 'active' : '' }}{{ Request::is('user/profile') ? 'active' : '' }}"><a href="{{route('user.profile-settings')}}"> <i class="icon-settings"></i>Settings</a></li>
      </ul> 
    </nav>
    @show
